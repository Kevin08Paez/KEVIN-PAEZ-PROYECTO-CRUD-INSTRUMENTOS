...
<%
    ...
    resultado = instrumento.InsertarInstrumento(new Instrumento(request.getParameter("nombre"), request.getParameter("idmarca"), Double.parseDouble(request.getParameter("precio")), request.getParameter("desc")));
%>
